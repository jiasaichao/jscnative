...
type IconProps = BaseProps & {
    ...
    height: number,
    background: string,
    name: 'arrowUp' | 'arrowRight' | 'arrowDown' | 'arrowLeft' | 'arrowBack' | 'arrowForward' | 'navigation'
}
    ...
    render() {
        ...
        switch (this.props.name) {
            ...
            case 'arrowForward':
                ...
                break;
            case 'navigation':
                content = <Polygon fill={this.props.color} stroke={this.props.color} strokeWidt={2} strokeLinecap='round' strokeLinejoin='round' strokeMiterlimit={10} points=" 31.7,45 45,15 15,28.3 15,28.3 29.6,30.4" />
                return (
                    <Svg viewBox="0 0 60 60" width={this.props.width} height={this.props.height} style={[{ backgroundColor: this.props.background || 'transparent'}, this.props.style]}>
                        {content}
                    </Svg>
                )
            default:
        ...
        return (
            <Svg viewBox="0 0 512 512" width={this.props.width} height={this.props.height} style={{ backgroundColor: this.props.background }}>
                {content}
            </Svg>
        );
    }
